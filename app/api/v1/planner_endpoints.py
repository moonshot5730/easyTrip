...
from app.internal.services.trip_planner_langgraph_service import fetch_graph_state_by_session, stream_trip_plan
...
async def trip_plan(chat_request: ChatRequest):
    ...
    return await stream_trip_plan(chat_request)
